...
namespace UMS_Final_Project1.Controllers
{
    public class DesignationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,DesignationVal")] Designation designation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,DesignationVal")] Designation designation)
        {
            if (ModelState.IsValid)
            {
